...
<html lang="fr">
  ...
  <body> 
    ...
    ?> <div class="container my-5">
      <div class="alert alert-warning text-center shadow-lg p-5">
        <div class="d-flex flex-column align-items-center gap-4">
          ...
          <!-- Description -->
          <p class="lead mb-4"> Vous devez être connecté pour accéder à cette page. <br> Merci de vous identifier. </p>
          <!-- Bouton de retour -->
    ...
    <script>
      ...
      if (countdownEl) {
        setInterval(() => {
          countdownEl2.textContent = --seconds2 > 0 ? seconds2 : '';
        }, 1000);
      }
    </script> <?php 
    ...
    exit();
     } else if(!isAdmin($_SESSION['email'] ?? '')) { ?> <div class="container my-5">
      <div class="alert alert-danger text-center shadow-lg p-5">
        <div class="d-flex flex-column align-items-center gap-4">
          ...
          <!-- Description -->
          <p class="lead mb-4"> Vous devez être administrateur pour accéder à cette page. <br> Veuillez contacter le support si vous pensez qu'il s'agit d'une erreur. </p>
          <!-- Boutons d'action -->
    ...
    redirect('index.php', 5);
    exit();
    } else { ?> <main class="container mt-5">
